...
const Login = () => {
    ...
    useEffect(() => {
        if (!authLoading && user) {
            ...
            // Wait until the role is physically fetched from the database by authStore
            if (role === null) {
                console.log("Login: Role is still null, waiting...");
                return;
            }
    ...
    }, [user, role, hasInitiative, authLoading, navigate, location.state]);
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <button
                            ...
                            disabled={loading}
                            className="w-full bg-white dark:bg-neutral-dark border border-slate-200 dark:border-neutral-border hover:bg-slate-50 dark:hover:bg-neutral-border/50 text-slate-800 dark:text-slate-100 font-bold py-4 rounded-xl shadow-sm transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                        >
